export const typographyStyles = [
  ...
  {
    name: "Body 2",
    code: '<p class="c-body-2">This longer body text where we show a bit more content in a paragraph is set as <strong>body 2</strong>, and it contains <em>italic</em> text.</p>'
  },
  {
    name: "Muted text",
    code: '<p class="u-muted">This longer body text where we show a bit more content in a paragraph is set as <strong>muted text</strong>, and it contains <em>italic</em> text.</p>'
  },
  {
    name: "Unordered list",
